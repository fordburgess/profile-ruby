...
projects = [
  {title: "VenuLet", description: "Make Your Event Eventful", tech: ["Ruby on Rails", "PostgreSQL"], background: "assets/venulet2.jpeg", width: "65%", color: "#0a79257e", font_color: "white", font: "EB Garamond", font2: "Petit Formal Script" },
